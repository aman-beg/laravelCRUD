                    ...
                    <form enctype="multipart/form-data" action="{{route('products.update',$product->id)}}" method="post">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="{{old('name', $product->name)}}" type="text" name="name" id=""
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{old('sku', $product->sku)}}" type="text" name="sku" id=""
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{old('price', $product->price)}}" type="text" name="price" id=""
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" name="description" id="" class="form-control form-control-lg"
